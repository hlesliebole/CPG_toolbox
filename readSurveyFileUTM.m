function [xutm,yutm,z,c]=readSurveyFileUTM(dataSource,dataFilename)

%-----------------------------------------
% GPS survey data loading
%-----------------------------------------

%if strcmpi(dataSource,'gps') || strcmpi(dataSource,'iG8wheel') % GPS llz file
...
elseif strcmpi(dataSource,'Multibeam')  
