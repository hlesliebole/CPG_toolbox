...
Mop1=find(strcmp('L0785',table2cell(Mop(:,1))));
Mop2=find(strcmp('L0800',table2cell(Mop(:,1))));
MopM=find(strcmp('L0794',table2cell(Mop(:,1))));
MopM2=find(strcmp('L0787',table2cell(Mop(:,1))));
...
PlotLabelLandMopTransect(MopM2,'2d','y','ShadeOff')
plot_google_map('MapType', 'satellite');
set(gca,'xlim',[-118.5805 -118.5571]);
set(gca,'ylim',[ 34.0325   34.0448],'fontsize',16);
title('Ratner & West Castle Rock Beach CDIP MOnitoring and Prediction (MOP) Transects','fontsize',18)
makepng('RatnerCastleRockMopOverview.png')
