...
text(1750,-10,{'Pad Reach'},'horizontalalign','center','fontsize',20,'color','y',...
    'fontweight','bold','backgroundcolor',[.7 .7 .7]);
title('Solana Beach Nourishment Pad Evolution :  24 May (ATV Miniranger) vs 10 May 2024','fontsize',20)
...
imagesc(xgimg,ygimg,dZ4,'AlphaData',~isnan(dZ4));hold on;
set(gca,'clim',[-1 1]);colormap(flipud(polarmap));cb=colorbar;
cb.Label.String='Elevation Change (m)';
 cb.Ticks=[-1:.2:1];
set(gca,'ylim',[-200 850]);
...
text(1750,-10,{'Pad Reach'},'horizontalalign','center','fontsize',20,'color','y',...
    'fontweight','bold','backgroundcolor',[.7 .7 .7]);
title('Solana Beach Nourishment Pad Evolution :  24 May (ATV Miniranger) vs 16 Apr 2024','fontsize',20)
...
lg=legend([b1 b2 b3 b4],'location','eastoutside','fontsize',14,'fontname','Monospaced');
