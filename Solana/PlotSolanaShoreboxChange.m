...
hold on;
imagesc(xgimg,ygimg,Z2,'AlphaData',~isnan(Z2));hold on;
set(gca,'clim',[0 6]);colormap(jet);cb=colorbar;
cb.Label.String='Change from Pre-nourishment Baseline (m)';
...
print(gcf,'-dpng','-r300','-loose','SolanaNourishment24Mar2024.png')
%%
