...
sdate(12)=datenum(2024,4,10);
sdate(13)=datenum(2024,4,18);
sdate(14)=datenum(2024,3,25);
...
for idx=ndx 
    ...
    elseif strcmp({CS(idx).Source},'Gps')  
        zdx=find(CS(idx).Z > -1 & CS(idx).Z < 0.7);
    else
        zdx=find(CS(idx).Z > 0.7);
    end
    %numel(zdx)
...
%%
% figure
imagesc(xgimg(1050:3000),ygimg,Z2(:,1050:3000));
colorbar
set(gca,'clim',[-12 4])
colormap(jet);
%%
