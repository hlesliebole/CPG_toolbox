...
Z7=Z;clear Z;
load SolanaPostnourishmentGrid21Jun24.mat
Z8=Z;clear Z;
...
b8=plot(uz-0.774,dztot/1000,'-','linewidth',2,'displayname',...
    ['16 Apr to 21 Jun[' num2str(-Z8dz*100,'%+4.1f') ']' SP8 dSP8 ' ' P8 dP8 ' ' NP8 dNP8]);hold on;
...
print(gcf,'-dpng','-r300','-loose','SolanaNourishment21JunVs16Apr24.png')
