...
idx=find(~isnan(Zg(:)));
[ScatterPlot,ColorBarPlot]=ColorScatter2dDeepElev(X(idx),Y(idx),Zg(idx));

set(gca,'xlim',[0 700],'ylim',[0 1200])
title({'','Multibeam 26 Jan 2024','North Edge Borrow Pit',''})
set(gcf,'position',[33          59        500         738]);
makepng('SolanaBorrowPitElevations.png')
