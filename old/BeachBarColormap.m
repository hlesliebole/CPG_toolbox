...
seamap=parula(14+land-1);
seamap=hsv(14+land-1);
%upper=gray(18);
...
%cl=[1 7:11 20:25 28 29 31:32];
cl=[1 1 7 7 8 8 9 9 10 10 11 11 20 20 21 21 22 22 23 23 24 24 25 25 28 28 29 29 31 31 32 32];
cm=jet(32);cm=cm(cl,:);
%colormap([seamap(1:end-15,:)' 1.4*flipud(cols(land+13:end,:))' flipud(upper(1:15,:))']');
%colormap([flipud(cm)' 1.4*flipud(cols(land+13:end,:))' flipud(upper(1:15,:))']');
colormap([flipud(cm)' 1.4*flipud(cols(land+13:end,:))' flipud(jet(15))']');
...
save BeachBarColorMap.mat BeachColorMap BeachColorBarLims...
