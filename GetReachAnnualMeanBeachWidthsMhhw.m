...
function [xmbw,mbw]=GetReachAnnualMeanBeachWidths(MopRange)

load MopShorelineMhhwV2.mat
...
for m=MopRange(1):MopRange(2)%666:682;%620:635;%638:662;%666:682 % Cardiff SB reach
    ...
    xSL=MopShoreline.MhhwDist(idx)+MopShoreline.TrkX0(idx); % Mhhw width in Mop back beach coords option (less valid data) 
