...
MopStart=55%582%666;%582; % start mop number
MopEnd=55%582%683;%590; % ending mop number
...
Z1(idx)=SG(SurvNum).Z(zdx); % overlay the valid data points using the 1d indices
...
Z1(Z1 < 1.344)=NaN;%Z1(Z1 < 0.774)=NaN;%
%Z1(Z1 > 3.0)=NaN;
