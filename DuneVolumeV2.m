...
set(gca,'dataaspectratio',[cosd(32)  1   50.0000]);
...
xlim([xl(1)-dx xl(2)+dx]);ylim([yl(1)-dy/2 yl(2)+dy]);
% zoom in on dune
...
% 
% title('Cardiff SB Living Shoreline Dune : Post-Storm (SIO 1/9/2023 Truck LiDAR Survey)',...
%     'fontsize',16)
% print(gcf,'-dpng','-r100','-loose','CardiffDune9Jan2023.png')
