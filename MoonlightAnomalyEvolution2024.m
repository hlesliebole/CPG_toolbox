...
% moonlight
MopStart=find(strcmp([Mop.Name],'D0701'));
MopEnd=find(strcmp([Mop.Name],'D0749'));
...
set(gca,'xlim',[-117.3191 -117.2786]);
set(gca,'ylim',[33.0250   33.0750]);
...
%%
makepng('MoonlightAnomalyEvolutionJuly2024v2.png')