...
%%
ndx=find((strcmp({CS.Source},'AtvMR') | strcmp({CS.Source},'Trk') | strcmp({CS.Source},'Gps')) &...
...
% san dieguito figure
figure('position',[1          12        400         783]);%plot(lon,lat,'y.');
...
%     'Mops 645 to 655'},...
%     'fontsize',16);
title({'Penasquitos Inlet, Torrey Pines',datestr(CS(idx).Datenum)},'fontsize',18)
set(gca,'xtick',[],'ytick',[]);box on;
pos=get(gca,'position');
set(gca,'position',[pos(1)-0.085 0.05 pos(3) 0.85])
