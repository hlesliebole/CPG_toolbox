...
figure('position',[31           1        1091         796]);
ax1=axes('position',[.05 .05 .4 .9]);set(ax1,'xlim',[min(x) max(x)],'ylim',[min(y) max(y)]);hold on;
% plot google map
...
hold on;
% overlay mop transects
for m=570:600
    plot([Mop.BackLon(m) Mop.OffLon(m)],[Mop.BackLat(m) Mop.OffLat(m)],...
        'w-');
    plot([Mop.BackLon(m)+Mop.OffLon(m)]/2,[Mop.BackLat(m)+Mop.OffLat(m)]/2,...
        'w*');
    text(Mop.OffLon(m),Mop.OffLat(m),num2str(m),'fontsize',12,'color','w',...
...
load TorreyPUVsites.mat Alat5 Alon5 Alat7 Alon7 Alat10 Alon10 Alat15 Alon15
p(1)=plot(Alon5,Alat5,'ko','markersize',7,'markerfacecolor','g','linewidth',2,'DisplayName','5m Sites');
p(2)=plot(Alon7,Alat7,'ko','markersize',7,'markerfacecolor','y','linewidth',2,'DisplayName','7m Sites');
p(3)=plot(Alon10,Alat10,'ko','markersize',7,'markerfacecolor','c','linewidth',2,'DisplayName','10m Sites');
p(4)=plot(Alon15,Alat15,'ko','markersize',7,'markerfacecolor','r','linewidth',2,'DisplayName','15m Sites');
legend(p,'location','southwest','fontsize',18)
...
ax2=axes('position',[.55 .05 .4 .9]);
set(ax2,'xlim',[min(x) max(x)],'ylim',[min(y) max(y)]);hold on;
%ax1=axes;set(ax1,'xlim',[-117.2886 -117.2772],'ylim',[32.9970   33.0167]);hold on;

% plot google map
plot_google_map('MapType', 'satellite','Alpha', 1,'axis',ax2)
...
title([{'USACE SHOALS Topo-Bathymetric LiDAR Elevations'},...
     {'Using a 11m x 11m 2D Moving Filter'}]);
xl=get(ax2,'xlim');yl=get(ax2,'ylim');
set(ax1,'xlim',xl,'ylim',yl);
load TorreyPUVsites.mat Alat5 Alon5 Alat7 Alon7 Alat10 Alon10 Alat15 Alon15
p(1)=plot(Alon5,Alat5,'ko','markersize',7,'markerfacecolor','g','linewidth',2,'DisplayName','5m Sites');
p(2)=plot(Alon7,Alat7,'ko','markersize',7,'markerfacecolor','y','linewidth',2,'DisplayName','7m Sites');
p(3)=plot(Alon10,Alat10,'ko','markersize',7,'markerfacecolor','c','linewidth',2,'DisplayName','10m Sites');
