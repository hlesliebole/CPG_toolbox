...
for MopNumber=676:676%509:509%507:507
...
set(gca,'ylim',[0 6.5],'xdir','reverse','fontsize',14);

% title([{['Mop ' num2str(MopNumber)]},{['Surveys Since ' datestr(SA(ndx(2)).Datenum)]}],...
%    'fontsize',16);
title([{['Mop ' num2str(MopNumber)]},{'2023-24 Profile Retreat' }],...
   'fontsize',16);
...
set(gca,'xlim',[-10 100])
makepng(['DuneMop' num2str(MopNumber) 'Profiles.png'])
