...
PrevMon=Mon;
fprintf('Building Global Monthly MEan grid for month : %i for %s\n',Mon,datetime(SA(surv).Datenum,'convertfrom','datenum'))
...
tl=text(-117.2831+0.001,mean([32.9968   33.0022]),{'Time of Year','  Elevation','Anomaly (m)'},'color','w','fontsize',16,'horizontalalign','left');
...
if nn == 1
    gif('TableTopZoomAnomalyLast3.gif','overwrite',true,'DelayTime',1.)%,'resolution',72,'nodither')
    nn=nn+1;
