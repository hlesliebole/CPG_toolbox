...
%  profile in M00586GM.mat
meanS=43; 

% 2. Most recent processed survey date [ SM(end).Datenum ] in M00586SM.mat 
survdate=datetime(2023,7,20,18,0,0,'TimeZone','America/Los_Angeles');
...
% get recent 586 xMSL locations from CPG MOP database
...
pfile=['Mop586shorelineForecast.png'];
