...
% MopRange=[639 663]; % Solana Mop range
% dname=['Solana Mops: ' num2str(MopRange(1)) ' to '  num2str(MopRange(2))];
% MopRange=[540 565]; % Cardiff SB Mop range
% dname=['South Torrey Mops: ' num2str(MopRange(1)) ' to '  num2str(MopRange(2))];
% MopRange=[497 514]; % LJ Shores SB Mop range
% dname=['La Jolla Shores Mops: ' num2str(MopRange(1)) ' to '  num2str(MopRange(2))];
% MopRange=[580 590]; % North TP SB Mop range
% dname=['North Torrey Mops: ' num2str(MopRange(1)) ' to '  num2str(MopRange(2))];
% MopRange=[621 635]; % North Del Mar Mop range
% dname=['North Del Mops: ' num2str(MopRange(1)) ' to '  num2str(MopRange(2))];
...
set(gca,'ylim',yl);
%set(gca,'xlim',[1980 2025],'xtick',1980:5:2025,'fontsize',14,'linewidth',2);
set(gca,'xlim',[1997 2023],'xtick',1997:2023,'fontsize',14,'linewidth',2);
grid on
legend(h,'location','northwest')
title('Annual Vos Mean MSL(?) Beach Width Evolution','fontsize',22)
%makepng('Test.png')
