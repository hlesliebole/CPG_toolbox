...
p1=surf(X-473300,Y-3651200,Z2-Z1,'linestyle','none');

%set(gca,'xlim',[0 474100-473300]);hold on;
...
text(50,1950,str,'fontweight','bold','fontsize',18);
...
didx=find([SG(jumbo).Datenum] ==  datenum(2007,10,10));
...
didx=find([SG(jumbo).Datenum] ==  datenum(2008,4,17));
didx=find([SG(jumbo).Datenum] ==  datenum(2008,1,9));
