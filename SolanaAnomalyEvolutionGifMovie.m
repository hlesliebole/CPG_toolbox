...
Mon=month(datetime(CS(surv).Datenum,'convertfrom','datenum'));
if Mon ~= PrevMon
...
t1=text(-117.272,mean([32.9684   33.0028]),datestr(CS(idx).Datenum),...
...
set(gca,'xlim',[-117.289 -117.259]);
set(gca,'ylim',[32.968   33.003]);
...
if nn == 1
    gif('SolanaAnomalyFast2.gif','overwrite',true,'DelayTime',.5)
    nn=nn+1;
