function [X1D,Z1D]=GetAllNearestPointsProfiles(SA,dy,dx)
...
% eg. for a median profile shape of all surveys at a mop while screening
%      for outliers
%   load M00583SA.mat
...
% if needed set path to CPG MOP files from your machine
