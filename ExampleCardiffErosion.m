...
zl=get(gca,'zlim');
%set(gca,'zlim',zl);
f=fill3([xl(1) xl(1) xl(2) xl(2) xl(1)],[yl(1) yl(2) yl(2) yl(1) yl(1)],[0 0 0 0 0],'k','facealpha',.1)
set(gca,'view',[-13.3871    5.3803])
BeachColorbar
box on
pause
set(gca,'zlim',zl);
delete(p2);p2=surf(X,Y,Z2,Z1-Z2,'linestyle','none');set(gca,'zlim',zl)
polarmap
set(gca,'clim',[-3 3])
