...
Vnav(2)=uicontrol(VolFig,'style','edit','position',[85 690 100 25],...
    ...
    'callback',...
    'CurrentMopNumber=str2num(Vnav(2).String);PlotAllVolumes');
...
Vnav(4)=uicontrol(VolFig,'style','edit','position',[410 690 100 25],...
    ...
    'callback',...
    'VolumeElevCutoff=str2num(Vnav(4).String);PlotAllVolumes');
...
Vnav(6)=uicontrol(VolFig,'style','edit','position',[830 690 100 25],...
    ...
    'callback',...
    'MinFractionSurveysWithData=str2num(Vnav(6).String);PlotAllVolumes');
...
Vnav(8)=uicontrol(VolFig,'style','edit','position',[1300 690 100 25],...
    ...
    'callback',...
    'MinFractionalCoverageAboveElevCutoff=str2num(Vnav(8).String);PlotAllVolumes');
