...
if exist('vax1','var');delete(vax1);end
if exist('vax2','var');delete(vax2);end
if exist('vax3','var');delete(vax3);end
if exist('vax4','var');delete(vax4);end
if exist('Vedit','var');delete(Vedit);end


MopNumber=CurrentMopNumber;
...
fprintf(' 4. %i unique Xutm,Yutm points in area.\n',numel(ia));
