...
s=fileread('/Users/William/desktop/CoastSat_transect_layer.geojson');
...
for n=2:size(ss,2)
    ...
    [Xutm,Yutm,UTMzone]=deg2utm(VosT(n).BackLat,VosT(n).BackLon);
